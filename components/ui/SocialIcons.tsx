...
/*
 * Brand glyphs are not part of the Lucide set (they were removed in v1), so
 * they are inlined here. They are drawn on the same 24px grid as every other
 * icon on the site to keep a single, consistent icon language.
 */
